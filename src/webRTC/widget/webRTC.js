...
define([
    ...
    "webRTC/lib/jquery-1.11.2",
    "dojo/text!webRTC/widget/template/webRTC.html"
    ...
    return declare("webRTC.widget.webRTC", [ _WidgetBase, _TemplatedMixin ], {
